                    ...
                    <div class="tab-content">
                                                ...
                                                <td>
                                                    <div style="display: table-row">
                                                        ...
                                                        <div style="display: table-cell; vertical-align: middle; padding-left: 5px; text-align: left;">
                                                            ...
                                                            <div>
                                                                <span>Product Id: </span><a href="/indivisualProduct/{{ encrypt($item->product_id) }}">{{$item->product_id}}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                        ...
                        <div id="shipping_discussion" class="tab-pane fade">
                            @if($Order['invoice_id'])
                                ...
                                @else
                                    <div>
                                        <form id="shipping" action="javascript:shippingCreator('{{$Order['order_id']}}')" method="post" enctype="multipart/form-data">

                                            <div class="form-group">
                                                <label>Tracking Id</label>
                                                <input class="form-control" type="text" name="tarcking_id">
                                            </div>
                                            <div class="form-group">
