        ...
        <div class="container">
            <div class="col-md-12 prd_con" style="margin-bottom: 20px;">
                <div class="col-md-3" style="text-align: center;">
                    <i class="fa fa-envelope fa-5x tracking" aria-hidden="true"></i><br>
                    <h4 style="color: orange;">Confirmed</h4>
                </div>
                <div class="col-md-3" style="text-align: center;">
                    @if($order['status'] == 'Invoice' || $order['status'] == 'Shipping' ||$order['status'] == 'Completed' || $order['status'] == 'Paid' || $order['status'] == 'Processing-Delivery' || $order['status'] == 'Cancelled' || $order['status'] == 'Complete' || $order['status'] == 'Unpaid')
                ...
                <div class="col-md-3" style="text-align: center;">
                    @if($order['status'] == 'Paid')
                        ...
                        <h4 style="color:orange">Completed</h4>
                        @else
